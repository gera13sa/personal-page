	...
	experience: [
		{
			...
			description: [
				...
				'Разработал и развернул корпоративный сайт организации для повышения заинтересованности потенциальный заказчиков.',
		...
		},
		{
			...
			description: [
				...
				'Разработал чат-бота для групп МФЦ ВКонтакте, позволяющего гражданам записываться в филиалы и отслеживать статус заявлений.',
